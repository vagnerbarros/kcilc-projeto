...
class ACL {
	...
	public static $ACL_ADMIN = 'Administrador';
	public static $ACL_CLIENTE = 'Cliente';
	public static $ACL_FUNCIONARIO = 'Funcionário';
	public static $ACL_USUARIO = 'Usuário';
