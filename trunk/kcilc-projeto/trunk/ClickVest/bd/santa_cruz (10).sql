...
CREATE TABLE IF NOT EXISTS `produto` (
  ...
  `tamanho` text COLLATE latin1_bin,
  `cor` text COLLATE latin1_bin,
  `categoria` text COLLATE latin1_bin,
  `status` text COLLATE latin1_bin,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_bin AUTO_INCREMENT=37 ;

--
-- Extraindo dados da tabela `produto`
--

INSERT INTO `produto` (`id`, `quantidade_estoque`, `descricao`, `valor`, `genero`, `tamanho`, `cor`, `categoria`, `status`) VALUES
(32, 6, 'descricao', 10, 'Masculino', 'PP', 'Branco', 'Terno', 'ATIVO'),
(33, 6, 'descricao', 10, 'Masculino', 'G', 'Azul', 'Cinto', 'ATIVO'),
(34, 5, 'teste', 100, 'Feminino', 'M', 'Verde', 'Vestido Curto', 'ATIVO'),
(35, 1, 'Calcinha de Plinio', 100, 'Feminino', 'GG', 'Preto', 'Vestido Longo', 'ATIVO'),
(36, 5, 'lajfsldkfjasldkj', 100, 'Feminino', 'PP', 'Branco', 'Sapato', 'ATIVO');
