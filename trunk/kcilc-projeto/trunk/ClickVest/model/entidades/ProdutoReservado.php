...
class ProdutoReservado implements Entidade {
	...
	//construtor
	public function ProdutoReservado($id_reserva, $id_produto, $quantidade, $status){
	...
	public function compareTo($obj){
		...
		return (($this->getIdReserva() == $obj->getIdReserva()) && ($this->getIdProduto() == $obj->getIdProduto()));
	}
	...
	public static function fromArray($hash){
		...
		return new ProdutoReservado($hash['id_reserva'], $hash['id_produto'], $hash['quantidade'], $hash['status']);
	}
