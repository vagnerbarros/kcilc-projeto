<?php 
class PoliticasAtendimentoPage extends Page {
	 ...
	 */
	public static $NM_PAGINA = 'PoliticasAtendimentoPage';
	...
	public function content($args, $lang){ 
		include 'PoliticasAtendimentoPage_content.php';
	}
